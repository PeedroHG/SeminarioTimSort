...
Este documento apresenta os resultados obtidos durante a execução do programa **dynamic_stack_ts** para diferentes volumes de dados. A medição foi realizada utilizando o comando `/usr/bin/time -v`.
...
Maximum resident set size (kbytes): 40368
Average resident set size (kbytes): 0
Major (requiring I/O) page faults: 0
Minor (reclaiming a frame) page faults: 12248
...
Average resident set size (kbytes): 0
Major (requiring I/O) page faults: 0
Minor (reclaiming a frame) page faults: 1118
